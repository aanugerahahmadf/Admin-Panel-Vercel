...
<head>
    ...
    <title><?php echo e($title ?? __('Verifikasi Kode')); ?></title>
    <style>
...
<body>
    <div class="wrapper">
        <div class="content">
            <div class="header">
                <h1><?php echo e(config('app.name', __('Panel Admin'))); ?></h1>
            </div>
            
            <div class="body">
                <h2><?php echo e($title ?? __('Kode Verifikasi')); ?></h2>
                
                <p><?php echo e(__('Halo')); ?>,</p>
                <p><?php echo e($description ?? __('Silakan gunakan kode verifikasi di bawah ini untuk menyelesaikan tindakan Anda. Kode ini berlaku selama 15 menit ke depan.')); ?></p>
                
                <div class="otp-container">
                    <div class="otp-code"><?php echo e($otp); ?></div>
                </div>
                
                <p><?php echo e(__('Jika Anda tidak meminta kode ini, Anda dapat mengabaikan email ini dengan aman. Jangan bagikan kode ini kepada siapa pun.')); ?></p>
                
                <p><?php echo e(__('Terima kasih')); ?>,<br><?php echo e(__('Tim')); ?> <?php echo e(config('app.name')); ?></p>
            </div>
            
            <div class="footer">
                <p>&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. <?php echo e(__('Seluruh hak cipta dilindungi undang-undang.')); ?></p>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\Weeding-Organizer-CBIR\AdminPanel_Mobile_Application\resources\views\emails\otp.blade.php ENDPATH**/ ?>