...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-breezy::components.grid-section','data' => ['md' => '2','title' => __('filament-breezy::default.profile.password.heading'),'description' => __('filament-breezy::default.profile.password.subheading')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['md' => '2','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('filament-breezy::default.profile.password.heading')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('filament-breezy::default.profile.password.subheading'))]); ?>
...
<?php endif; ?>
<?php /**PATH D:\Weeding-Organizer-CBIR\AdminPanel_Mobile_Application\vendor\jeffgreco13\filament-breezy\resources\views\livewire\update-password.blade.php ENDPATH**/ ?>