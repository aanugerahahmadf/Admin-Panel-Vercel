<div x-data="{
    otp: $wire.entangle('<?php echo e($getStatePath()); ?>'),
    length: 6,
    activeInput: 0,
    handlePaste(e) {
        e.preventDefault();
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 0; $i < 6; $i++): ?>
        <input
            ...
            @focus="activeInput = <?php echo e($i); ?>"
...
<?php /**PATH D:\Weeding-Organizer-CBIR\AdminPanel_Mobile_Application\resources\views\filament\auth\otp-field.blade.php ENDPATH**/ ?>