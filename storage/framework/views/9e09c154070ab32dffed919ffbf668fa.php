...
<div class="interface-container">
    <div class="interface-inner">
        ...
        <div class="qr-frame">
            ...
            <div class="qr-code">
                <img src="<?php echo e($qrCodeDataUri); ?>" alt="Scan to Connect">
            </div>
        </div>
        ...
        <div class="connection-status">
            <div class="status-row">
                ...
                <span class="value"><?php echo e($displayHost); ?></span>
            </div>
            <div class="status-row">
                <span class="label">PORT</span>
                <span class="value-alt"><?php echo e($port); ?></span>
            </div>
...
<?php /**PATH D:\Weeding-Organizer-CBIR\AdminPanel_Mobile_Application\vendor\nativephp\mobile\resources\jump\views\qr-offline.blade.php ENDPATH**/ ?>